...
class Interprocess {
  ...
  struct LayoutParameter {
    ...
    System.Int32 bound_x;
    /// @brief サンプル内の原点のY座標
    /// @warning NullLayout,NativeLayoutでは無視される
    System.Int32 bound_y;
    /// @brief サンプル内の幅
    /// @warning NullLayout,NativeLayoutでは無視される
    System.Int32 bound_width;
    /// @brief サンプル内の高さ
    /// @warning NullLayout,NativeLayoutでは無視される
    System.Int32 bound_height;
    /// @brief キャプチャを行う対象となるウィンドウ
    System.UInt64 window;
    /// @brief 取り込み範囲の開始X座標
    System.Int32 clipping_x;
    /// @brief 取り込み範囲の開始y座標
    System.Int32 clipping_y;
    /// @brief 取り込み範囲の幅
    System.Int32 clipping_width;
    /// @brief 取り込み範囲の高さ
    System.Int32 clipping_height;
    /// @brief マウスカーソルの表示
    System.Byte show_cursor;
    /// @brief レイヤードウィンドウの表示
    System.Byte show_layered_window;
    /// @brief 拡大縮小アルゴリズムの選択
    /// @attention SWScaleFlagsを操作に使うこと
    System.Int32 sws_flags;
    /// @brief 取り込み範囲が出力サイズより小さい場合拡張
    System.Byte stretch;
    /// @brief アスペクト比の保持
    System.Byte keep_aspect_ratio;
    /// @brief 回転方向
    /// @attention RotateDirectionを操作に使うこと
    System.Int32 rotate_direction;
  }
  ...
  struct Message {
    ...
    System.Int32 layout_type;
    /// @brief 有効なレイアウト要素の数
    System.Int32 layout_element_count;
    /// @brief レイアウトパラメータの配列
