...
AVFilterFormats *ff_merge_formats(AVFilterFormats *a, AVFilterFormats *b)
{
    ...
    //---------------------------------------------------------------------
    // 2012/06/30 modified by Alalf
    MERGE_FORMATS(ret, a, b, int, formats, format_count, AVFilterFormats, fail);
    //---------------------------------------------------------------------
                                                 ...
                                                 AVFilterChannelLayouts *b)
{
    ...
    if (a->nb_channel_layouts && b->nb_channel_layouts) {
        //---------------------------------------------------------------------
        // 2012/06/30 modified by Alalf
        MERGE_FORMATS(ret, a, b, uint64_t, channel_layouts, nb_channel_layouts,
...
AVFilterFormats *ff_make_format_list(const int *fmts)
{
    //---------------------------------------------------------------------
    // 2012/06/30 modified by Alalf
    MAKE_FORMAT_LIST(AVFilterFormats, int, formats, format_count);
    //---------------------------------------------------------------------
    while (count--)
...
int ff_parse_pixel_format(enum PixelFormat *ret, const char *arg, void *log_ctx)
{
    ...
    // 2012/06/30 modified by Alalf
    // **WARNING** int->enum static_casting
    *ret = static_cast<PixelFormat>(pix_fmt);
    //---------------------------------------------------------------------
    return 0;
}
